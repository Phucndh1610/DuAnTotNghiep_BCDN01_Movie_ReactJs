...
export const HomeTemplate = lazy(() => {
  return new Promise((resolve) => {
    setTimeout(
      () => resolve(import("./templates/HomeTemplate/HomeTemplate")),
      1500
    );
  });
});
export const CheckoutTemplate = lazy(() => {
  return new Promise((resolve) => {
    setTimeout(
      () => resolve(import("./templates/CheckoutTemplate/CheckoutTemplate")),
      1500
    );
  });
});
      ...
      <Suspense fallback={<LoadingHome />}>
        <Router history={history}>
          <Switch>
            ...
            <CheckoutTemplate
              exact
              path="/checkout/:id/:maPhim"
              Component={Checkout}
              mobileComponent={CheckoutMobile}
            />

            <AdminTemplate path="/admin/films" exact Component={films} />
            <AdminTemplate
              path="/admin/films/addfilm"
              exact
              Component={AddFilm}
            />
            <AdminTemplate
            ...
            />
            <AdminTemplate
              path="/admin/users/editUser/:taiKhoan"
              exact
              Component={EditUsers}
            />
          </Switch>
