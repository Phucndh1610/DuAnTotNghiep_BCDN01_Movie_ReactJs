...
function Profile() {
  ...
  const { userLogin, thongTinTaiKhoanND } = useSelector(
  ...
  return (
    <div className="row profile__content">
      <div
        className="col-lg-2 col-md-3 col-sm-3 col-6 profile--user text-center px-0"
        style={{ left: position }}
      >
        <button
          className="openMenu"
        ...
        <div
          className="user--nav nav flex-column nav-pills py-3"
          id="v-pills-tab"
          role="tablist"
      ...
      <div className="col-lg-10 col-md-9 col-sm-9 col-12 profile--info">
        <div className="info--blur">
          ...
          >
            <div
              className="content--information tab-pane fade show active"
              id="v-pills-home"
              role="tabpanel"
            ...
            >
              ...
              <div className="row">
                <div className="col-lg-6 col-sm-12">
                  <p>
                    Bạn có thể xem toàn bộ thông tin đã đăng kí và thay đổi mật
                    khẩu tại đây!
                  </p>
                    ...
                    <form onSubmit={formik.handleSubmit}>
                      ...
                      <div className="field--item">
                        <CssTextField
                          ...
                          onBlur={formik.handleBlur}
                          helperText={
                            formik.touched.matKhau2 && formik.errors.matKhau2
                              ? formik.errors.matKhau2
                              : ""
                          }
                          error={
                            formik.touched.matKhau2 && formik.errors.matKhau2
            ...
            <div
              className="content--history tab-pane fade"
              id="v-pills-profile"
              role="tabpanel"
